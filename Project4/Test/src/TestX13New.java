...
public class TestX13New {
    ...
    public static PrintWriter sortie = null;
   ...
   **************************************************
    ...
    public static void Ecrire(int ecriture, int pts,int temp) throws IOException {
        ...
        Debogue("Dans Ecrire() avec ecriture="+ecriture);
        ...
        switch (ecriture) {
           /* case 1:
            ...
            /*case 2:
                ...
                //IMPORTANT
            case 3:
                sortie.println("Félicitations " + uneStr
                        + "********Le gagnant***********");
                break;
                //IMPORTANT
            case 4:
                sortie.println("*****" + NomDuJoueur()
                        + " roule 1 - ***PERD POINTS TEMPORAIRES");
                break;
                //IMPORTANT
            case 5:
                sortie.println(NomDuJoueur()
            ...
            case 6: 
                 sortie.println(uneStr +" rouler: " + pts+ " " );
                break;
                case 7: 
                 sortie.print("temp= "+temp + "   ***" + joueur1Str + " a "+ totalJoueur1+"pts et"+ joueur2Str + "en a "+totalJoueur2 );
                    break;
        }
...
//le scan devient public pour tout le monde
   ...
   **************************************************
     */
    public static int RouleLeDai()throws IOException {
   ...
   **************************************************
     */
    public static int AsTuGagner(int pts)throws IOException {
